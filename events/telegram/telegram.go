...
/*_______________________________________________________________________________________
	Явное отличие между апдэйтами(Updates) и эвентами(Events) заключается в следующем:
...
func (p Processor) processMessage(event events.Event) error {
	...
	//в зависимости от типа сообщения выбираем определённое действие с ним
	//если пользователь скинул ссылку - сохраняем её
	//если пользователь отправил команду RND - то мы должны найти ссылку из сохранённых и вернуть ему
