...
//Метод получения апдэйтов(новых сообщений) Возвращает структуру в будет содержаться то что нам нужно знать об апдэйте и возможно ошибку
//Типы(структуры) для удобства работы с ними вынесены в отдельный файл types в этом же пакете
// Входные параметры: limit - колиество апдэйтов, которок мы будем получать за один запрос;
